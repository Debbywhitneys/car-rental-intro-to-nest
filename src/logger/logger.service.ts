...
export class LoggerService extends ConsoleLogger {
  ...
  log(message: any, context?: string, ip?: string): void {
    ...
    void this.writeToFile('log', String(message), context, ip);
  }
  ...
  error(message: any, context?: string, ip?: string, trace?: string): void {
    ...
    const errorMessage = `${safeMessage}${safeTrace}`;

    void this.writeToFile('error', errorMessage, context, ip);
  }

  warn(message: any, context?: string, ip?: string): void {
    super.warn(message, context);
    void this.writeToFile('warn', String(message), context, ip);
  }

  debug(message: any, context?: string, ip?: string): void {
    super.debug(message, context);
    void this.writeToFile('debug', String(message), context, ip);
  }

  verbose(message: any, context?: string, ip?: string): void {
    super.verbose(message, context);
    void this.writeToFile('verbose', String(message), context, ip);
  }
